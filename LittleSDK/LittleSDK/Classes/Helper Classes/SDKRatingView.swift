...
@objc public protocol SDKRatingViewDelegate {
    /**
    ...
    */
    @objc optional func floatRatingView(_ ratingView: SDKRatingView, isUpdating rating: Float)
}
...
*/
@IBDesignable
open class SDKRatingView: UIView {
    
    // MARK: Properties
    
    open weak var delegate: SDKRatingViewDelegate?
